...
CREATE TABLE CUSTOMER_BOOKING_DETAILS (
    ...
    TRIP_DETAILS VARCHAR(255) NULL,    -- Optional trip notes/details
    STATUS ENUM('ACTIVE', 'PENDING', 'CANCELED', 'FOR VERIFICATION', 'FOR PICKUP', 'ONGOING', 'EXTENDED', 'COMPLETED') DEFAULT 'PENDING',
    CREATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (USER_ID) REFERENCES USER_DETAILS(USER_ID) ON DELETE CASCADE,
